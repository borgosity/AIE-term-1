...
void InitChallenges(Challenge *challenge[])
{
	...
	challenge[0] = new FleeChallenge(challenge0, 0);
	...
	challenge[5] = new Question(Question1, Answer1);
	challenge[6] = new Question(Question2, Answer2);
	challenge[7] = new Question(Question3, Answer3);
	challenge[8] = new Question(Question4, Answer4);
	challenge[9] = new Question(Question5, Answer5);
	challenge[10] = new PhysicalChallenge(challenge11, difficulty);
	challenge[11] = new PhysicalChallenge(challenge12, difficulty);
	challenge[12] = new PhysicalChallenge(challenge13, difficulty);
	challenge[13] = new PhysicalChallenge(challenge14, difficulty);
	challenge[14] = new PhysicalChallenge(challenge15, difficulty);
...
void InitEnemies(Enemy * Enemies[])
{
	...
	Enemies[0] = new Enemy(enemyLoc, enemyName1, strength, health, luck );
	Enemies[1] = new Enemy(enemyLoc, enemyName2, strength, health, luck );
	Enemies[2] = new Enemy(enemyLoc, enemyName3, strength, health, luck );
	Enemies[3] = new Enemy(enemyLoc, enemyName4, strength, health, luck );
	Enemies[4] = new Enemy(enemyLoc, enemyName5, strength, health, luck );
}
...
void InitEnemies(std::vector<Enemy*> Enemies)
{
	...
	StringOO enemyName4 = "Susan the Lazy";
	StringOO enemyName5 = "Justin the Yellow";
	std::vector<StringOO> enemyNames = { enemyName1, enemyName2, enemyName3, enemyName4, enemyName5 };

	//for ( auto i : enemyNames)
	//Enemies.push_back(new Enemy(enemyLoc, enemyName1, strength, health, luck));
	//Enemies.push_back(new Enemy(enemyLoc, enemyName2, strength, health, luck));
	//Enemies.push_back(new Enemy(enemyLoc, enemyName3, strength, health, luck));
	//Enemies.push_back(new Enemy(enemyLoc, enemyName4, strength, health, luck));
	//Enemies.push_back(new Enemy(enemyLoc, enemyName5, strength, health, luck));
}
...
void DestroyEnemies(Player *challenge[], int length)
{
	for (int i = 0; i < length; i++)
	{
		delete challenge[i];
